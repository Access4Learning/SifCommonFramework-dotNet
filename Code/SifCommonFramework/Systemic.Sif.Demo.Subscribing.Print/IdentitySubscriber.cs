...
namespace Systemic.Sif.Demo.Subscribing.Print
{
    ...
    /// <summary>
    /// Subscriber of Identity data objects.
    /// </summary>
    class IdentitySubscriber : GenericSubscriber<Identity>
    {
        ...
        /// <summary>
        /// This implementation will simply print the received Identity record to the console.
        /// </summary>
        ...
        /// This implementation will simply print the received Identity record to the console.
        /// </summary>
        /// <param name="sifDataObject">Identity record received</param>
        /// <param name="zone">Zone the Identity record was received from.</param>
