...
namespace Systemic.Sif.Demo.Subscribing.Print
{
    ...
    /// </summary>
    public class StaffPersonalSubscriber : GenericSubscriber<StaffPersonal>
    {
        ...
        protected override void ProcessEvent(SifEvent<StaffPersonal> sifEvent, IZone zone)
        {
            ...
            if (log.IsDebugEnabled) log.Debug("Received a " + sifEvent.EventAction.ToString() + " event for StaffPersonal in Zone " + zone.ZoneId + ".");
        }
