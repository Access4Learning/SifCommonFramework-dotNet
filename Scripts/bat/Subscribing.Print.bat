...
set EXECUTABLE_PATH=\soe\Projects\SifCommonFramework\Code\SifCommonFramework\Systemic.Sif.Demo.Subscribing.Print\bin\Release\
set EXECUTABLE=Systemic.Sif.Demo.Subscribing.Print.exe
